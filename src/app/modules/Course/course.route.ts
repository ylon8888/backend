...
router.get(
  "/chapter-enroll-student/:chapterId",
  CourseController.chapterEnrollStudent
);
router.get("/chapter-quiz-details", CourseController.capterQuizDetails);

// Course details
router.get(
  "/course-details/:subjectId",
  auth(),
...
// Checking enrollemnt
router.get(
  "/checking-enrollment/:subjectId",
  auth(),
  CourseController.checkingEnrollment
);
...
router.get(
  "/course-review",
  auth(UserRole.ADMIN),
  CourseController.getAllCourseReview
); //  <--- Admin
...
// Course Entroll
router.post(
  "/course-enroll/:subjectId",
  auth(),
  CourseController.createCourseEnroll
);
