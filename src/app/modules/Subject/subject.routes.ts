...
router.patch(
  "/update-visibility/:subjectId",
  SubjectController.updatevisibility
);
router.patch(
  "/delete/:subjectId",
  auth(UserRole.ADMIN),
  SubjectController.deletecourse
);
router.get("/", SubjectController.getAllSubjects);
router.get(
  "/subject-wise-chapter/:subjectId",
  auth(),
  SubjectController.subjectWiseChapter
);
