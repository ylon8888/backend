...
router.get(
  "/enroll-course-chapter/:subjectId",
  auth(),
  StudentController.studentEnrollChapter
);
router.get(
  "/chapter-quiz/:chapterId",
  auth(),
  StudentController.studentChapterQuizAttempt
);
...
router.post(
  ...
  auth(),
  fileUpload,
  StudentController.createUpdateProfile
...
router.get(
  "/overall-graph",
  auth(UserRole.ADMIN),
  StudentController.getOverallGraph
); // auth(UserRole.ADMIN)
router.get(
  "/participation",
  auth(UserRole.ADMIN),
  StudentController.participation
); // auth(UserRole.ADMIN)
router.get(
  "/admin-get-student/:studentId",
  auth(UserRole.ADMIN),
